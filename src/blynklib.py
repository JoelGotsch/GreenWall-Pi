...
class Blynk(Connection):
    ...
    def __init__(self, token, gw = None, tm=None, **kwargs):
    ...
    def addEvent(self, event_name, func):
        """event name must be something like "read v1" or "write v8", func a function which will be called when
        blynk tries to call this function"""
